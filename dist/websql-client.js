var PrimusAdaptor, READ_ONLY_REGEX, SQLiteFactory, SQLitePlugin, SQLitePluginTransaction, argsArray, dblocations, nextTick, root, txLocks;
...
SQLitePlugin.prototype.transaction = function(fn, error, success) {
  ...
  this.addTransaction(new SQLitePluginTransaction(this, fn, error, success, true, false, this.primusAdaptor));
};
...
SQLitePlugin.prototype.readTransaction = function(fn, error, success) {
  ...
  this.addTransaction(new SQLitePluginTransaction(this, fn, error, success, true, true, this.primusAdaptor));
};
...
SQLitePlugin.prototype.executeSql = function(statement, params, success, error) {
  ...
  this.addTransaction(new SQLitePluginTransaction(this, myfn, null, null, false, false, this.primusAdaptor));
};
...
SQLitePluginTransaction = function(db, fn, error, success, txlock, readOnly, primusAdaptor) {
...
SQLitePluginTransaction.prototype.run = function() {
  var batchExecutes, errcb, handlerFor, i, mycb, mycbmap, qid, request, tropts, tx, txFailure, waiting;
  txFailure = null;
  tropts = [];
...
PrimusAdaptor = (function() {
  ...
  PrimusAdaptor.prototype.backgroundExecuteSqlBatch = function(onSuccess, onError, args) {
    this.cblist[this.id] = {
      s: onSuccess,
      e: onError
    };
